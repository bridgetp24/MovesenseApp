package com.test.movesenseapp.adb;
...
import com.test.movesenseapp.section_03_dfu.DfuUtil;
...
public class AdbBridge extends BroadcastReceiver {
    ...
    private final String LOG_TAG = com.test.movesenseapp.adb.AdbBridge.class.getSimpleName();
