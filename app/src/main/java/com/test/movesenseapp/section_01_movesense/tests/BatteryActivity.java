...
import com.test.movesenseapp.model.EnergyGetModel;
...
public class BatteryActivity extends BaseActivity implements BleManager.IBleConnectionMonitor {
    ...
    private static final String TAG = com.test.movesenseapp.section_01_movesense.tests.BatteryActivity.class.getSimpleName();
    ...
    public void onDisconnect(String s) {
        ...
        if (!isFinishing()) {
            runOnUiThread(() -> ConnectionLostDialog.INSTANCE.showDialog(com.test.movesenseapp.section_01_movesense.tests.BatteryActivity.this));
        }
    }
