            ...
            mdsSubscription = Mds.builder().build(this).subscribe(URI_EVENTLISTENER,
                    FormatHelper.formatContractToJson(MovesenseConnectedDevices.getConnectedDevice(0)
                        ...
                        public void onError(MdsException error) {
                            ...
                            Toast.makeText(com.test.movesenseapp.section_01_movesense.tests.LinearAccelerationTestActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
...
//        }
    ...
    public void onDisconnect(String s) {
        ...
        if (!isFinishing()) {
            runOnUiThread(() -> ConnectionLostDialog.INSTANCE.showDialog(com.test.movesenseapp.section_01_movesense.tests.LinearAccelerationTestActivity.this));
        }
    }
