package com.test.movesenseapp.google_drive;
...
public class SendLogsToGoogleDriveActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    case 0:
                                        ...
                                        Uri uri = FileProvider.getUriForFile(com.test.movesenseapp.google_drive.SendLogsToGoogleDriveActivity.this,
                ...
                if (mGoogleApiClient != null && mGoogleApiClient.isConnected()) {
                    ...
                    mGoogleApiClient.clearDefaultAccountAndReconnect().setResultCallback(new ResultCallback<Status>() {
                        ...
                        public void onResult(@NonNull Status status) {
                            ...
                            Toast.makeText(com.test.movesenseapp.google_drive.SendLogsToGoogleDriveActivity.this, "You are log out", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private void chooseAccount() {
        ...
        if (EasyPermissions.hasPermissions(
            ...
            Log.d(LOG_TAG, "has permission to get account, fetching pref account name");
            ...
            if (accountName != null) {
                ...
                Log.d(LOG_TAG, "account null starting dialog to choose account");
            ...
            Log.d(LOG_TAG, "does not have permission to get account, requesting permissions");
    ...
    void showGooglePlayServicesAvailabilityErrorDialog(final int connectionStatusCode) {
        ...
        Dialog dialog = apiAvailability.getErrorDialog(
                com.test.movesenseapp.google_drive.SendLogsToGoogleDriveActivity.this,
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, Void> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            Log.d(LOG_TAG, "running MakeRequestTask");
            Log.d(LOG_TAG, "creating new HttpTransport");
            HttpTransport transport = AndroidHttp.newCompatibleTransport();
            Log.d(LOG_TAG, "creating new jsonFactory");
            JsonFactory jsonFactory = JacksonFactory.getDefaultInstance();
            Log.d(LOG_TAG, "building mService");
            mService = new com.google.api.services.drive.Drive.Builder(
                    transport, jsonFactory, credential)
                    .setApplicationName("Movesense logs")
                    .build();

            Log.d(LOG_TAG, "mService built");
        }
        ...
        private void sendFileToGoogleDrive() throws IOException {
            ...
            for (com.google.api.services.drive.model.File file : fileList.getFiles()) {
                ...
                if (file.getName().equals(MOVESENSE_DIRECTORY_GOOGLEDRIVE_NAME)) {
                    ...
                    Log.d(LOG_TAG, "Parent folder found");
            ...
            if (directoryFile != null) {
                ...
                Log.d(LOG_TAG, "created parent dir");
                ...
                Log.d(LOG_TAG, "insert file to created directory");
            }
        }
        ...
        protected void onCancelled() {
            Log.d(LOG_TAG, "running onCancelled sequence");
            mProgress.hide();
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    Log.d(LOG_TAG, "mLastError is a GooglePlayServicesAvailabilityIOException");
                    showGooglePlayServicesAvailabilityErrorDialog(
                            ((GooglePlayServicesAvailabilityIOException) mLastError)
                                    .getConnectionStatusCode());
                } else if (mLastError instanceof UserRecoverableAuthIOException) {
                    Log.d(LOG_TAG, "UserRecoverableAuthIOEception");
                    startActivityForResult(
                            ((UserRecoverableAuthIOException) mLastError).getIntent(),
                            com.test.movesenseapp.google_drive.SendLogsToGoogleDriveActivity.REQUEST_AUTHORIZATION);
                } else {
                ...
                Toast.makeText(com.test.movesenseapp.google_drive.SendLogsToGoogleDriveActivity.this, "Request cancelled.", Toast.LENGTH_SHORT).show();
            }
        }
    }
